...
@section('head-scripts')
    <script src="{{url('/bower_resources/angular/angular.min.js')}}"></script>
    <script src="{{url('/bower_resources/angular-route/angular-route.min.js')}}"></script>
    <script src="{{url('/js/comment-app/app.js')}}"></script>
    <script src="{{url('/js/comment-app/controllers/CommentController.js')}}"></script>
@endsection
